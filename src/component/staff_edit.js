...
export default class staff_edit extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        .then((response) =>{
            this.setState({
                ...
                phone: response.data[0].STAFF_TEL,
                addr: response.data[0].STAFF_ADDR,                
                pass: response.data[0].STAFF_PASS
            ...
            <div>
               ...
               <section className="sidebar">
                ...
                <section className="features">
                    <h2 className="features-title">Staff Update</h2>
